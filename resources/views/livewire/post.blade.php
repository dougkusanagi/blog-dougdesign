            ...
            <div class="xl:divide-y xl:divide-gray-200 xl:dark:divide-gray-700">
                ...
                <div
                            ...
                            <ul
                                ...
                                <li class="flex items-center space-x-2">
                                    <img alt="avatar" loading="lazy" width="38" height="38" decoding="async"
                                        data-nimg="1" class="h-10 w-10 rounded-full"
                    ...
                    <div class="divide-y divide-gray-200 dark:divide-gray-700 xl:col-span-3 xl:row-span-2 xl:pb-0">
                        ...
                        <div class="pb-6 pt-6 text-sm text-gray-700 dark:text-gray-300"><a target="_blank"
                                rel="nofollow"
                                ...
                                on GitHub</a></div>
                        <div class="pb-6 pt-6 text-center text-gray-700 dark:text-gray-300" id="comment"><button>Load
                                Comments</button></div>
                    </div>
