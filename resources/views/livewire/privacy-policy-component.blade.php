<div class="divide-y divide-gray-200 dark:divide-gray-700">
    ...
    <div class="pt-12 prose dark:prose-invert max-w-none dark:prose-in">
        <h2>Política Privacidade</h2>
        <p>A sua privacidade é importante para nós. É política do respeitar a sua privacidade em relação a qualquer
            informação sua que possamos coletar no site <a href="https://blog.dougdesign.com.br/">DougDesign</a>, e
            outros sites
        ...
        <ul>
            ...
            <li>Vários parceiros anunciam em nosso nome e os cookies de rastreamento de afiliados simplesmente nos
                ...
                qualquer promoção que possa fornecê-lo para fazer uma compra.</li>
        </ul>
        <h3>Compromisso do Usuário</h3>
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o oferece no site e com
        ...
        <ul>
            ...
            <li>Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, Bet Nacional ou azar, qualquer tipo
                de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
            <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do , de seus fornecedores ou
        ...
        <p>Esta política é efetiva a partir de 22 November 2023 19:17</p>
    </div>
