...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body
        class="antialiased text-black bg-white dark:bg-gray-950 dark:text-white"
    >
        <section class="max-w-3xl px-4 mx-auto sm:px-6 xl:max-w-5xl xl:px-0">
            <div class="flex flex-col justify-between h-screen font-sans">
                <header class="flex items-center justify-between py-10">
                    ...
                    <div
                        class="flex items-center space-x-4 leading-5 sm:space-x-6"
                    >
                        <a
